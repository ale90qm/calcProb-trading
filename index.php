    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const createCalculatorHTML = (indexId, indexName, checkboxStates = []) => {
                const confirmations = ["Estructura (Tendencia primaria H4 y 1D)", "Tendencia Secundaria (H1)", "Fallo de Tendencia a favor (H1 o H4)", "Zona de polaridad (H1 o H4)", "Patrón de Velas (H1 o H4)", "Zona de soporte, resistencia e intermedia (M15 en base a H1)", "Zona Activa (M15)", "Línea de Tendencia (M15 en base a H1)", "Canales (M15 en base a H1)", "Acción del precio (M15, M5 y M1)"];
