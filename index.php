    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const createCalculatorHTML = (indexId, indexName, checkboxStates = []) => {
                const confirmations = ["Estructura, Tendencia primaria (H4)", "Tendencia Secundaria (H1)", "Fallo de Tendencia a favor (H1)", "Zona de polaridad (H1)", "Patrón de Velas (H1)", "Canales (H1)", "Zona de soporte, resistencia e intermedia (M15)", "Zona Activa (M15)", "Línea de Tendencia (M15)", "Tendencia Terciaria, Acción del precio (M15, M5 y M1)"];
