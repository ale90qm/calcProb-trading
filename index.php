    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const createCalculatorHTML = (indexId, indexName, checkboxStates = []) => {
                const confirmations = ["Estructura, Tendencia primaria en H4 o 1D (MINIMOS y MAXIMOS a favor del INDICE)", "Tendencia Secundaria en H1 (MINIMOS y MAXIMOS a favor del INDICE)", "Fallo de Tendencia en H1", "Zona de polaridad en H1, (El precio ha reaccionado con fuerza en esa zona)", "Patrón de Velas en zonas de polaridad en H1, demostrando debilidad de la tendencia anterior y fuerza a favor del indice", "Canales (H1)", "Zona de soporte, resistencia e intermedia (M15)", "Zona Activa en M15 y H1, el precio respeta la zona tanto para subir como para bajar, aunque sean testeos pequeños", "Línea de Tendencia en M15 y H1", "Tendencia Terciaria, Acción del precio en M15, M5 y M1, el precio en continuidad debe respetar punto de entrada o ruptura anterior, punto de reaccion, punto maximo de reaccion y fallo"];
